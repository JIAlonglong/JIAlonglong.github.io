...
- **Project Background**:
  ...
  <img src="https://mmbiz.qpic.cn/mmbiz_png/ehPZ8OY5Mno3d39gD2WbAt9OcjrvaIV62Coia20Oh7TZmyX3PaXHvibhecZTLe4Tus5O5G5h75qchibUZQjERFiabw/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1" title="" alt="图片" data-align="center">
  
                              Figure 4. Physical picture of R2 automatic robot
...
- **Main Contributions**:
  ...
  *R2 Control Manager*
  ...
  1. Robot Automatic Positioning
     ...
     <img src="https://img1.baidu.com/it/u=2437612314,2796548114&fm=253&fmt=auto&app=120&f=JPEG?w=667&h=500" title="" alt="" data-align="center">
     
                                             Figure 5.Mid360 physical picture
...
                                       Figure 6.Positioning algorithm architecture diagram
...
2. Robot Path Algorithm Development
   ...
   <img src="file:///C:/Users/24954/AppData/Roaming/marktext/images/2025-03-06-21-57-58-image.png" title="" alt="" data-align="center">
   
                           Figure 7.Limiting the robot's real-time path in rviz
   ...
   ![](C:\Users\24954\AppData\Roaming\marktext\images\2025-03-06-22-12-16-image.png)
   
                                   Figure 8.Parameter management diagram
...
- **Project Background**:
  ...
  <img title="" src="file:///C:/Users/24954/AppData/Roaming/marktext/images/2025-03-07-09-32-14-image.png" alt="" data-align="center">
  
                                         Figure 9.Overall picture of R1 robot
...
- **Main Contributions**:
  ...
  *Control Manager*
  ...
  1. Optimization of motor control modules
     ...
     <img src="file:///C:/Users/24954/AppData/Roaming/marktext/images/2025-03-07-17-02-43-image.png" title="" alt="" data-align="center">
     
                                         Figure 10.Motor Mode Code Block
     ...
     - **Position Mode**
       ...
       ![](C:\Users\24954\AppData\Roaming\marktext\images\2025-03-07-17-03-40-image.png)
       
                               Figure 11.Motor position mode code block
...
                        Figure 12.Motor position mode algorithm architecture diagram
...
- **Return To Zero Mode**
  ...
  2. **Position Mode Check**: When in position mode and the target position is reached, set a completion flag to trigger mode switching.
     ...
     1. **Speed Control**: Execute speed-loop PID calculation to regulate the motor’s rotational speed.
        ...
        <img src="file:///C:/Users/24954/AppData/Roaming/marktext/images/2025-03-07-17-13-36-image.png" title="" alt="" data-align="center">
        
                            Figure 13.Motor return to zero mode code block
...
- **Setting Mode**
  ...
  <img title="" src="file:///C:/Users/24954/AppData/Roaming/marktext/images/2025-03-07-17-23-05-image.png" alt="" data-align="center">
  
  Figure 14.Motor setting mode code block
...
```
 ...
                             Figure 15.Flowchart of DMA Serial Communication
...
- **Project Background:**
  ...
  ![](C:\Users\24954\AppData\Roaming\marktext\images\2025-03-07-22-21-53-a63d85f3d993004dbf952c8d1e26318.jpg)
  
                                  Figure 22.Physical picture of rabbit robot
...
- **Main Contributions:**
  ...
  1. Building ros_control-based system without lower computer
     ...
     ![](C:\Users\24954\AppData\Roaming\marktext\images\2025-03-07-22-24-43-image.png)
     
                                     Figure 23.Ros-control data flow diagram
     
     ![](C:\Users\24954\AppData\Roaming\marktext\images\2025-03-07-22-26-54-image.png)
     
                                         Figure 24.rc_control frame diagram
     ...
     ![](C:\Users\24954\AppData\Roaming\marktext\images\2025-03-07-22-29-47-image.png)
     
                                         Figure 25.Groot software interface
     
     ![](C:\Users\24954\AppData\Roaming\marktext\images\2025-03-07-22-30-26-image.png)
     
                                        Figure 26.XML configuration interface
...
                                     Figure 27.Hybrid A * Algorithm Architecture Diagram
...
- **Project Backgrond:**
  ...
  ![](C:\Users\24954\AppData\Roaming\marktext\images\2025-03-08-09-54-58-b7f8576a07712cc1438a1dcf6399018.jpg)
  
                                  Figure 28.Physical picture of elephant robot

- **Main Contributions:** 
  
  1. Solution and Control of Three-wheel Steering Wheel
     
     <img src="file:///C:/Users/24954/AppData/Roaming/marktext/images/2025-03-08-10-05-57-image.png" title="" alt="" data-align="center">
     
                                     Figure 29.Three-wheel experimental chassis
     ...
     **Steering angle calculation**:<img title="" src="file:///C:/Users/24954/AppData/Roaming/marktext/images/2025-03-08-11-47-07-5ddaab845f8858d3ead6348ed39007b.png" alt="" width="211">
     
     From the above formula, it can be converted to matrix form:
     
     <img src="file:///C:/Users/24954/AppData/Roaming/marktext/images/2025-03-08-11-51-26-image.png" title="" alt="" data-align="center">
     
                                         Figure 30.Calculate the merge process
     
     Note: 1/3 of the parameters here may require specific adjustments
  
  2. Path Planning Based on STM32
