...
2. Robot Path Algorithm Development
   ...
   ![error](https://github.com/JIAlonglong/JIAlonglong.github.io/blob/master/images/real_time_path.png?raw=true)
...
- **Project Background**:
  ...
  ![error](https://github.com/JIAlonglong/JIAlonglong.github.io/blob/master/images/R1_2024.png?raw=true)
...
- **Main Contributions**:
  ...
  *Control Manager*
  ...
  1. Optimization of motor control modules
     ...
     ![error](https://github.com/JIAlonglong/JIAlonglong.github.io/blob/master/images/motor_control.png?raw=true)
...
- **Main Contributions:**
  ...
  1. Building ros_control-based system without lower computer
     ...
     ![error](https://github.com/JIAlonglong/JIAlonglong.github.io/blob/master/images/ros_control.png?raw=true)
...
- **Main Contributions:** 
  ...
  1. Solution and Control of Three-wheel Steering Wheel
     ...
     ![error](https://github.com/JIAlonglong/JIAlonglong.github.io/blob/master/images/chassis.png?raw=true)
